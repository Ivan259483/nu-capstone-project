/**
 * Customer live tracker — mapping to `trackerStageMedia[].stage` on bookings.
 * Keep in sync with frontend/src/lib/customer-tracker-stage-media.ts (+ tracker-gate-photo-slots.ts).
 */
...
/** Dashboard 5-step tracker step id → API stage (same as web DASHBOARD_TRACKER_STEP_MEDIA_STAGE). */
export const MOBILE_TRACKER_STEP_MEDIA_STAGE: Record<string, TrackerMediaStage | null> = {
  confirmed: 'confirmed',
  received: 'received',
