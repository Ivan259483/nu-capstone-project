 ...
 *   index -> analyzing -> results -> optional repair-preview / prepare-3d -> ar-view -> estimate -> confirm
...
export default function AiScanLayout() {
  return (
    ...
    >
      ...
      <Stack.Screen name="repair-preview" options={{ animation: 'slide_from_right' }} />
