        ...
        >
            ...
            <div className="max-w-6xl mx-auto relative z-[1]">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20 items-center">
                    ...
                    >
                        {/* Glow behind image */}
                        <div className="absolute -inset-4 bg-gradient-to-br from-orange-500/10 via-transparent to-indigo-500/10 blur-3xl rounded-3xl pointer-events-none" />
                        ...
                        <motion.div style={{ y: imageY }} className="relative">
                            <img
                                ...
                                className="w-full h-[480px] lg:h-[580px] object-cover rounded-2xl shadow-2xl border border-white/10"
                            />
