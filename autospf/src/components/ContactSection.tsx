...
const inputCls =
    ...
    'focus:outline-none focus:border-orange-500/60 transition-colors duration-200';
...
export default function ContactSection() {
    ...
    return (
        ...
        >
            {/* Ambient glows */}
            <div className="absolute top-10 left-1/4 w-[500px] h-[300px] bg-indigo-500/4 blur-[120px] rounded-full pointer-events-none" />
            <div className="absolute bottom-10 right-1/4 w-[400px] h-[250px] bg-orange-500/5 blur-[100px] rounded-full pointer-events-none" />
            ...
            <div className="max-w-6xl mx-auto relative z-10">
                ...
                >
                    <motion.p
                        variants={fadeUp}
                        className="text-[10px] uppercase tracking-[0.5em] text-orange-400/70 font-semibold mb-3"
                    >
                        Get in touch
                    </motion.p>
                    <motion.h2
                ...
                >
                    {[
                        ...
                        <motion.div
                            key={label}
                            variants={fadeUp}
                            className="group flex items-start gap-5 p-8 bg-white/[0.03] hover:bg-white/[0.06] border border-white/5 hover:border-white/10 transition-all duration-300"
                        >
                            <div className="w-10 h-10 shrink-0 rounded-lg bg-white/5 border border-white/8 flex items-center justify-center group-hover:bg-orange-500/10 group-hover:border-orange-500/20 transition-all duration-300 mt-0.5">
                                <Icon className="w-4 h-4 text-white/40 group-hover:text-orange-400 transition-colors duration-300" />
                            </div>
                            <div>
                            ...
                            <ul className="space-y-4 mb-10">
                                {BULLET_POINTS.map(point => (
                                    <li key={point} className="flex items-start gap-3 text-sm text-white/50 font-light">
                                        <ChevronRight className="w-3.5 h-3.5 text-orange-500/60 shrink-0 mt-0.5" />
                                        {point}
                                    </li>
                                ))}
                            </ul>
                        ...
                        {submitted ? (
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div>
                                    ...
                                    >
                                        <option value="" disabled className="bg-[#0B1120] text-white/40">
                                            Select a service...
                                        </option>
