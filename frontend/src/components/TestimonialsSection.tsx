...
const testimonials = [
    {
        name: "Carlos Reyes",
        role: "BMW M3 Owner",
        text: "AutoSPF+ transformed my car completely. The ceramic coating they applied is phenomenal — water beads off like magic! The attention to detail is world-class.",
        rating: 5,
    ...
    },
    {
        ...
        text: "Napakagaling ng kanilang serbisyo! Ang aking SUV ay mukhang bago pagkatapos ng full detail package. Highly recommended sa lahat!",
        rating: 5,
    ...
    },
    {
        ...
        text: "Very professional and thorough. My car came back looking better than when I first bought it. Will definitely be a repeat customer!",
        rating: 5,
    ...
    },
    {
        ...
        text: "Great experience from booking to pickup. The team kept me updated throughout and the results exceeded my expectations by far.",
        rating: 5,
