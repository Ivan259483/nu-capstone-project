...
export const BookingWizard: React.FC<BookingWizardProps> = ({ services, vehicles, user, onClose, onSuccess, onAddVehicle }) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            formData.append('customer', user._id || user.id || '');
            ...
            formData.append('service', selectedService._id || selectedService.id || ''); // Explicit reference
            ...
            formData.append('items', JSON.stringify([{
                product: selectedService._id || selectedService.id,
                quantity: 1,
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pb-4">
                        {activeServices.map((service, index) => (
                            <div
                                ...
                                className={`cursor-pointer group relative overflow-hidden rounded-xl border-2 transition-all duration-300 ${(selectedService?._id || selectedService?.id) === (service._id || service.id)
                            ...
                            >
                                <div className="aspect-[16/9] relative">
                                    ...
                                    />
                                    {/* Overlay */}
                                    <div className={`absolute inset-0 transition-opacity duration-300 ${(selectedService?._id || selectedService?.id) === (service._id || service.id)
                                        ? 'bg-indigo-900/20'
                                    ...
                                    {/* Selection Indicator */}
                                    <div className={`absolute top-3 right-3 transition-all duration-300 ${(selectedService?._id || selectedService?.id) === (service._id || service.id)
                                ...
                                <div className="p-4 relative">
                                    ...
                                    {(selectedService?._id || selectedService?.id) === (service._id || service.id) && (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {vehicles.map((vehicle, index) => (
                                    <div
                                        ...
                                        onClick={() => setSelectedVehicleId(vehicle._id || vehicle.id || '')}
                                        className={`cursor-pointer p-4 rounded-xl border-2 transition-all duration-300 ${selectedVehicleId === (vehicle._id || vehicle.id)
                                    ...
                                    >
                                        <div className="flex items-start justify-between">
                                            ...
                                            {(selectedVehicleId === (vehicle._id || vehicle.id)) && (
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <p className="font-medium text-white">
                                    {vehicles.find(v => (v._id || v.id) === selectedVehicleId)?.make} {vehicles.find(v => (v._id || v.id) === selectedVehicleId)?.model}
                                </p>
                                <p className="text-sm text-zinc-400">{vehicles.find(v => (v._id || v.id) === selectedVehicleId)?.plateNumber}</p>
                            </div>
                            <div>
