...
export function CustomerTopbar({ greeting, onOpenNavigation, onBook, children }: {
  greeting: string; onOpenNavigation: () => void; onBook?: () => void; children?: ReactNode;
}) {
  return <header className="customer-topbar">
    <div className="customer-topbar__heading">
      ...
      <div className="customer-dashboard-heading"><p className="customer-topbar__greeting">{greeting}</p></div>
    </div>
