/**
 * Booking flow — Terms & Conditions (Step 5 of 6).
 * Single source for web; keep mobile `constants/bookingTerms.ts` in sync when editing.
 */
...
/** Shown above the full legal text in the web booking flow (Step 5). */
...
/** Display metadata for the booking terms document (not legal advice). */
