...
export const normalizeBooking = (raw: any): Booking => {
    ...
    const booking = {
        ...
        customerStage: raw?.customerStage,
        customerStageLabel: raw?.customerStageLabel,
        customerStageStep: raw?.customerStageStep,
        customerStageTotalSteps: raw?.customerStageTotalSteps,
        customerStageProgress: raw?.customerStageProgress,
        customerStageRank: raw?.customerStageRank,
        customerAssignedTeam: raw?.customerAssignedTeam,
        // Backend-owned tracking lifecycle — clients never decide "is it done" themselves.
        customerTrackingState: raw?.customerTrackingState,
        customerTrackingLive: raw?.customerTrackingLive,
        customerTrackingCompletedAt: raw?.customerTrackingCompletedAt ?? null,
        customerReceiptInvoiceId: raw?.customerReceiptInvoiceId ?? null,
