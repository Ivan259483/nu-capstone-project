export const en = {
    ...
    contact: {
        ...
        pillLocation: "Las Piñas City",
        pillReply: "Reply Within 24 Hours",
    ...
    // Login
    login: {
        title: "Log in to AutoSPF+",
        subtitle: "Secure access for appointments, vehicle status, and service history",
        bookingContext: "Sign in to continue your booking.",
        normalTitle: "Welcome back",
        normalSubtitle: "Sign in to access your AutoSPF+ account.",
        bookingTitle: "Continue your booking",
        bookingSubtitle: "Sign in to reserve your AutoSPF+ service.",
    ...
    auth: {
        ...
        invalidCodeAttempts: "Incorrect code. {n} attempt(s) remaining.",
        codeExpiredResend: "That code expired. Request a new one below.",
        verifySessionExpired: "Your verification session expired. Please sign in again.",
        lockedCountdown: "Locked. Try again in {n}.",
    ...
    // CTA Section
    cta: {
        title: "Ready to Protect Your Finish?",
        subtitle: "Book your premium detailing session and experience long-lasting gloss, clarity, and protection.",
        button: "Book Now",
        call: "Call Us",
    },
