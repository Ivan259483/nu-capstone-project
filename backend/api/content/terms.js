/**
 * Booking Terms & Conditions — server-side copy (mirrors frontend `src/lib/booking-terms.ts`).
 * Expose via API later if needed; for now booking UIs import from frontend/mobile constants.
 */
'use strict';

const BOOKING_TERMS_DOCUMENT_TITLE = 'AutoSPF+ Terms & Conditions';

const BOOKING_TERMS_INTRO =
